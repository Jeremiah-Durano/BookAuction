...
/* book/show.html.twig */
class __TwigTemplate_eeac2c7b0ced91c326cdaa655bdb81bd21c2bb4c8b263590b3cf1e1d19736bba extends \Twig\Template
{
    private $source;
    ...
    public function __construct(Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("no-sidebar.html.twig", "book/show.html.twig", 1);
        $this->blocks = [
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["book"]) || array_key_exists("book", $context) ? $context["book"] : (function () { throw new RuntimeError('Variable "book" does not exist.', 12, $this->source); })()), "id", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Name</th>
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["book"]) || array_key_exists("book", $context) ? $context["book"] : (function () { throw new RuntimeError('Variable "book" does not exist.', 16, $this->source); })()), "name", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Author</th>
                <td>";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["book"]) || array_key_exists("book", $context) ? $context["book"] : (function () { throw new RuntimeError('Variable "book" does not exist.', 20, $this->source); })()), "author", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Description</th>
...
{% block pageHeader %}Book{% endblock %}
{% block body %}
    <h1>Book</h1>
    ...
    <a href=\"{{ path('book_index') }}\"><button type=\"button\" class=\"btn btn-primary btn-sm\" >Back to list</button></a>

    <a href=\"{{ path('book_edit', {'id': book.id}) }}\"><button type=\"button\" class=\"btn btn-primary btn-sm\" >Edit</button></a>

    {{ include('book/_delete_form.html.twig') }}
{% endblock %}
", "book/show.html.twig", "/Users/jeremiah/Desktop/BookAuction/templates/book/show.html.twig");
    }
}
