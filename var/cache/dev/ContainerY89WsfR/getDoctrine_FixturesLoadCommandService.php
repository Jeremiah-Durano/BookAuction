...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\Book(), 'groups' => []]]);
