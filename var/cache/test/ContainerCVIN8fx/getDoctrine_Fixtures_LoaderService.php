...
include_once $this->targetDirs[3].'/src/DataFixtures/Book.php';

$this->privates['doctrine.fixtures.loader'] = $instance = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);

$instance->addFixtures([0 => ['fixture' => ($this->privates['App\DataFixtures\AppFixtures'] ?? $this->load('getAppFixturesService.php')), 'groups' => []], 1 => ['fixture' => ($this->privates['App\DataFixtures\Book'] ?? ($this->privates['App\DataFixtures\Book'] = new \App\DataFixtures\Book())), 'groups' => []]]);
